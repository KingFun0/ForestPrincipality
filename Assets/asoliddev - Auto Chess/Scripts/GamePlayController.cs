...
public class GamePlayController : MonoBehaviour
{
    ...
    public int baseGoldIncome = PlayerResources.Coins;
    ...
    [HideInInspector]
    public int currentGold = PlayerResources.Coins;
    [HideInInspector]
    ...
    public bool BuyChampionFromShop(Champion champion)
    {
        ...
        if (PlayerResources.Coins < champion.cost)
            return false;
        ...
        PlayerResources.Coins -= champion.cost;
        //set gold on ui
        uIController.UpdateUI();
    ...
    public void RestartGame()
    {
        ...
        //reset stats
        currentHP = 100;
        currentGold = PlayerResources.Coins;
        currentGameStage = GameStage.Preparation;
